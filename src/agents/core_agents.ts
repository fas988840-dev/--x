 ...
 *
 * IMPORTANT: these are NOT autonomous/LLM agents. There is no model call,
 * no free-form generation, and no invented data anywhere in this file.
 * Every field returned either:
